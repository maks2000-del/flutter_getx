      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            _contestsList(context, _list, width),
            SizedBox(
              height: 30,
            ),
            _recentContestsBtn(),
            ...
            _recentContestsList(context, _info, width),
          ],
        ),
      ),
    );
...
Widget _contestsList(BuildContext context, List info, double width) {
  return Container(
    height: 220,
...
Widget _recentContestsList(BuildContext context, List list, double width) {
  return Expanded(
