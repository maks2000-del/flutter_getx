      ...
      body: Container(
        ...
        child: Stack(
          children: [
            ...
            _participantsCount(),
            _usersImgList(imgs),
            _favouriteIBtn(detailController),
          ],
        ),
      ),
    );
...
Widget _userInfoArea(double width) {
  return Positioned(
    top: 120,
    left: 0,
    height: 100,
...
Widget _contestInfo(double width) {
  return Positioned(
    top: 250,
    left: 0,
    width: width,
...
Widget _usersImgList(List imgs) {
  return Stack(
    children: [
...
Widget _favouriteIBtn(DetailController controller) {
  return Positioned(
    top: 670,
    left: 25,
    child: Row(
